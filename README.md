...
| `kvasir verify-service-account <target>` | Verifies the 1Password item, target SSH reachability, FreeIPA/SSSD user resolution, SSSD SSH keys, service-account SSH login, and `sudo -n true` without prompting. |
